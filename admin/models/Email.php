...
class Email extends PHPMailer{
    ...
    public function enviar_correo(){
        ...
        $usuario = new Usuario();
        $datos2 = $usuario->get_usuario_suscrito();
        ...
        foreach ($datos2 as $row2) {
          ...
          $this->addBCC($row2["usu_correo"]); //Copia oculta
          $this->WordWrap = 50;
          $this->IsHTML(true);
          ...
          $cuerpo = str_replace('$xemaildesuscribirse', 'http://localhost:8080/PERSONAL_ENVIO_MASIVO_CORREO/admin/view/desuscribirse/?email='.$row2["usu_correo"], $cuerpo);
          $cuerpo = str_replace('$xcorreo', $row2["usu_correo"], $cuerpo);
          $this->Body = $cuerpo;
