<?php
    class Usuario extends Conectar {
        public function login() {
            ...
            if (isset($_POST["enviar"])) {
                ...
                if (empty($correo) or empty($password)) {
                    header("Location: " . Conectar::ruta() . "admin/index.php?m=2");
                    exit();
                }else{
                    ...
                    if(is_array($resultado)==true and count($resultado)>0){
                        ...
                        header("Location: " . Conectar::ruta() . "admin/view/Home/");
                        exit();
                    }else{
                        header("Location: " . Conectar::ruta() . "admin/index.php?m=1");
                        exit();
                    }
                }
            }
        ...
        public function get_usuario_suscrito(){
            $conectar=parent::conexion();
            parent::set_names();
